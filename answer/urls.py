...
urlpatterns = [
    ...
    path('answer/<int:pk>/document/popup/add/', AnswerDocumentUploadView.as_view(), name='document_popup_add'),
    path('answer/<int:pk>/document/upload', file_upload_view, name='upload_document'),
]
